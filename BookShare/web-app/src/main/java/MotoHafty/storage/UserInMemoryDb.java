...
public class UserInMemoryDb implements UserDb {
    ...
    private void importUsersFromJson(){
        ...
        userList.add(new User("ancymon","Jarek", "Szczepanik", "jarovo@go2.pl", "haslo1", new Adress("Ćwiartki 3/4", "Wrocław", Province.DOLNOŚLĄSKIE, "50-001"), true, new HashSet<>(Arrays.asList(1, 2, 3)) ,new HashSet<>(Arrays.asList(1, 3))));
