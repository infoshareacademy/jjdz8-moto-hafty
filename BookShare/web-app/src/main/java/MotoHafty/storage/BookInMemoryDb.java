...
public class BookInMemoryDb implements BookDb {
    ...
    private void importBooksFromJson(){
        ...
        bookList.add(new Book("Drucker o marketingu", "William A. Cohem", authorsTestList, "Literatura Użytkowa | Popularnonaukowe", "978-83-63566-24-1", generateDateInStringNow(), true, "książka o czymś"));
